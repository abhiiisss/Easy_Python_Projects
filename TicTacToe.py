...
def user_play(user_icon):
    ...
    #place the user icon according to the user choice space
    if board[user_choice-1] == " ":
        board[user_choice-1] = user_icon    
    elif board[user_choice-1] != " ":
        print("This is already taken, try another")
...
while True:
    ...
    #none of them wins, another user plays
    user_play('O')
    print_board()
